  ...
  return (
    <div>
      ...
      <div className="casos-detalle-container">
        ...
        <p>
          En el Centro de Ayuda y Soporte, puedes encontrar respuestas a tus
          preguntas, acceder a recursos Utiles y contactar con nuestro equipo de
          soporte para obtener asistencia personalizada. Explora nuestras guías,
          tutoriales y preguntas frecuentes para resolver cualquier duda o
