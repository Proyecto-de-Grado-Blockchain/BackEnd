        ...
        <div className="container-activos">
            ...
            <div className="content">
                <div className="casos-activos-container">
                    ...
                    <p>En esta sección, puedes ver y gestionar todos los 
                       forenses que han sido cerrados. Filtra y accede a
                        cada caso para obtener información detallada, revisar 
                        actualizaciones, verificar responsabilidades o consultar 
                        el estado final de cada proceso.</p>
                </div>
                ...
                <div className="input-container">
                    ...
                    <div className="search-icon-container">
                        <img src={lupa} alt="Buscar" className="search-icon" onClick={handleBuscar} />
                    </div>
                    ...
                    <div className="input-wrapper">
                        ...
                        {menu2Open && (
                            <div className="dropdown-menu">
                                <button onClick={() => handleSelectOption('Estado', 2)}>Estado</button>
                                <button onClick={() => handleSelectOption('Fecha', 2)}>Fecha</button>
                                <button onClick={() => handleSelectOption('Médico Forense', 2)}>Médico Forense</button>
