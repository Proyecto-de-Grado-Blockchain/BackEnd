        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <div className="d-block p-0 text-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)' }}>
              ...
              <img src={carruselimg3} className="imagenesCarrusel" style={{ height: '100px' }} alt="Gestión de Casos Forenses" />
            </div>
          </div>
          <div className="carousel-item">
            <div className="d-block p-0 text-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)' }}>
              ...
              <img src={carruselimg2} className="imagenesCarrusel" style={{ height: '80px' }} alt="Seguridad de Datos" />
            </div>
          </div>
          <div className="carousel-item">
            <div className="d-block p-0 text-center" style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)'}}>
              ...
              <img src={carruselimg1} className="imagenesCarrusel" style={{ height: '80px' }} alt="Acceso Simplificado" />
            </div>
          </div>
        </div>
